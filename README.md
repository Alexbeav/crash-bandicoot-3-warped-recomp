# Crash Bandicoot 3: Warped Recompiled

This release candidate uses PSXRecomp and the shared recomp-ui launcher.
You must supply your own SCUS-94244 game disc and SCPH-5502/5552 Europe BIOS.
...
2. Start `Crash_Bandicoot_3__Warped_Recompiled` (`.exe` on Windows).
