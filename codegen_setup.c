...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Crash Bandicoot 3: Warped",
    .project_root_env = "CRASH_BANDICOOT_3_WARPED_PROJECT_ROOT",
    .build_dir_env = "CRASH_BANDICOOT_3_WARPED_BUILD_DIR",
    .force_setup_env = "CRASH_BANDICOOT_3_WARPED_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCUS_942.44_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Crash_Bandicoot_3__Warped_Recompiled",
    .prepare_note =
